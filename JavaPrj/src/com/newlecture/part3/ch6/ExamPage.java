...
public class ExamPage {
	...
	/*
	 * 1. Composition Has A 관계 : 일체형 ExamPage 에서 Exam exam = new Exam() 1.
	 * Association Has A 관계 : 결합형 main 에서 page.setExam(exam) 1. Aggregation Has A 관계
	 * : 집합형 ExamPage 에서 Exam[] exam = new Exam[10]
	 */
